...
def process_fif_file(file_path):
    ...
    impression_ids = model.generate(inputs_impression["input_ids"], max_new_tokens=200, num_beams=4, early_stopping=True, temperature=0.7, top_p=0.9, num_return_sequences=1)
...
with open('report_meditron.txt', 'w') as f:
    f.write(report)
