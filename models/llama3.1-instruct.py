...
def process_fif_file(file_path):
    ...
    # Remove everything after "The final answer is"
    if "The final answer is" in impression:
        impression = impression.split("The final answer is")[0].strip()
...
#file_path = r"\\NRC-065359\Abbotsford\00a84163-cce2-4610-ba92-6f809000d50a_raw.fif"
#file_path = r"\\NRC-065359\Abbotsford\00a98643-95da-4e01-9c33-30d4b9b7804c_raw.fif"
#file_path = r"\\NRC-065359\Abbotsford\00b1faea-e1a5-4066-8cbd-bb5a993eabbd_raw.fif"
file_path = r"\\NRC-065359\Abbotsford\00b0574e-dc9e-4b07-983f-b956bf81ed81_raw.fif"
...
with open('./reports/llama3.1-8b-instruct/report2.txt', 'w') as f:
    f.write(report)
